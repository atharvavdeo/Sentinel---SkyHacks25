...
│  │  ↓                            ↓     │     │
│  │  Main Tracker    Training Simulator│     │
│  │  (App.jsx)       (index5.html)     │     │
│  └────────────────────────────────────┘     │
│         ↓ (Axios HTTP)                       │
└─────────┼────────────────────────────────────┘
...
│         ↓                                    │
│  ┌────────────────────────────────────┐     │
│  │  Static Data (orbitalData.json)    │     │
│  │  - 260 Satellites                  │     │
│  │  - 1500 Debris Objects             │     │
│  │  - Stochastic Collision Scenarios  │     │
│  └────────────────────────────────────┘     │
└─────────────────────────────────────────────┘
```
...
- **Atharva Deo** - Full Stack Development, 3D Visualization, Orbital Mechanics, UI/UX Design

### Contributions
- React + Three.js integration with React Three Fiber
- Keplerian orbital propagation algorithms
- Stochastic collision detection system
- Aerospace-themed UI design with SVG icons
